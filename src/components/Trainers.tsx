      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {VICI_TRAINERS.map((trainer) => (
            <div
              key={trainer.id}
              className="bg-[#FBF9F4] rounded-3xl border border-[#E8DFC8] overflow-hidden shadow-2xs hover:shadow-md hover:border-[#D69A2D] transition-all flex flex-col group"
            >
              {/* Photo Area */}
              ...
              <div className="p-6 flex flex-col flex-grow space-y-4">
                ...
                <div className="pt-2 border-t border-[#E8DFC8]">
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#FFFDF8] border border-[#D5C7AA] hover:border-[#8A6437] text-xs font-bold text-[#8A6437] hover:bg-[#F4EADA]/60 transition-all cursor-pointer"
                  >
