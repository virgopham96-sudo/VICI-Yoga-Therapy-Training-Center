        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2.5 rounded-full border border-[#D5C7AA] hover:bg-[#F8F5EE] text-xs font-semibold text-[#555A4E] transition-all cursor-pointer flex items-center gap-1.5"
            >
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-full bg-[#D69A2D] text-white text-xs font-bold hover:bg-[#B87A14] shadow-2xs transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg shrink-0 transition-all cursor-pointer ${
                selectedCategory === c.id
                  ? 'bg-[#D69A2D] text-white font-semibold'
            ...
            >
              ...
              <div className="pt-3 border-t border-[#F0E8D7] flex items-center justify-between text-xs">
                ...
                <button
                  ...
                  className="text-xs font-bold text-[#D69A2D] hover:text-[#B87A14] flex items-center gap-0.5 cursor-pointer"
                >
                  <span>Chọn lớp</span>
