import { Target, Compass, HeartHandshake, Cpu, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-16 bg-[#F8F5EE] rounded-3xl p-8 sm:p-12 border border-[#E8DFC8]">
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="p-4 rounded-xl bg-[#FFFDF8] border border-[#E8DFC8] flex items-start gap-3">
              <Cpu className="w-5 h-5 text-[#D69A2D] shrink-0 mt-0.5" />
              <div className="text-xs sm:text-sm text-[#555A4E]">
                <strong className="text-[#252822]">Tư duy đổi mới công nghệ:</strong> VICI coi AI như một "Trợ lý", ứng dụng công nghệ để phân loại nhu cầu, chia sẻ giáo án, thiết kế vườn trị liệu chữa lành và nâng cấp hệ thống microphone net chuyên dụng trong phòng tập.
              </div>
            </div>
          </div>
