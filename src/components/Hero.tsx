        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="pt-6 border-t border-[#E8DFC8] grid grid-cols-2 sm:grid-cols-3 gap-4 w-full text-xs text-[#555A4E]">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Đào tạo y bác sĩ BV Tâm Anh & Vinpearl</span>
              </div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -top-4 -left-4 bg-[#FFFDF8] border border-[#E8DFC8] px-3.5 py-2 rounded-xl shadow-md hidden sm:flex items-center gap-2">
                <ShieldCheck className="w-5 h-5 text-[#D69A2D]" />
                <div className="text-left">
                  <p className="text-[11px] font-bold text-[#252822]">52+ Ca Trị Liệu</p>
                  <p className="text-[10px] text-[#717769]">Hệ cơ xương khớp</p>
                </div>
              </div>
            </div>
          </div>
