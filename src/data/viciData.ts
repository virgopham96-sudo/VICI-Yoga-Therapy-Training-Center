import { Course, Trainer, ActivitySpace, FAQItem, Lead } from '../types';
...
export const VICI_INFO = {
  ...
  meaning: {
    ...
    technologyMindset: 'Doanh nghiệp ứng dụng AI như một "Trợ lý", đưa công nghệ vào việc tư vấn chia sẻ khóa học, thiết kế không gian vườn trị liệu chữa lành, vườn café tỉnh thức và phòng tập trang bị hệ thống microphone net tối ưu cho trị liệu.'
  },
...
export const VICI_ASSETS = {
  ...
  chanMay: {
    primary: 'https://lh3.googleusercontent.com/pw/AP1GczPIerOkQ4mpB74zeS8Z50RHU-VrOJY5QUPvpFwWJZo-PA8kl17ihKopUwihUZxnKi7z1XIVi0jQJ2GJbwawBPnGCuQQyjNKB0Tzqn-MoK_S4lrFNJs=w1200',
    sourceUrl: 'https://photos.app.goo.gl/js1Jynj6GAxgurdeA'
  },
  daChieu: {
...
export const VICI_COURSES: Course[] = [
  ...
  },
  {
    ...
    photoUrl: VICI_ASSETS.henry.teaching,
    sourcePhotoUrl: VICI_ASSETS.henry.sourceUrl
  },
  {
